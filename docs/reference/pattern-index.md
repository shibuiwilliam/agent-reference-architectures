...
| A2 | [Durable Async Agent｜耐久非同期セッション](../patterns/a-execution/a2-durable-async-agent.md) | a-execution | `[F1, F7, F15, F16, F17]` | `[reversibility, latency_budget, accountability]` | `` | stable |
...
| A6 | [Adaptive Timeout & Budget-Bounded Retry｜適応タイムアウト＋予算律速リトライ](../patterns/a-execution/a6-adaptive-timeout-retry.md) | a-execution | `[F1, F7, F12]` | `[latency_budget, cost_sensitivity, failure_cost, provider_trust]` | `` | stable |
...
| B3 | [Agentic Loop with Budget｜予算付き自律ループ](../patterns/b-orchestration/b3-agentic-loop-budget.md) | b-orchestration | `[F13, F2, F6]` | `[task_variability, cost_sensitivity]` | `` | stable |
