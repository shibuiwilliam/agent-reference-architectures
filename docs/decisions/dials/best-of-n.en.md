...
- [#10 Agent Ensemble & Debate](../../decisions/tradeoffs-catalog/same-vs-different-model.md) -- Composition pattern for generating, debating, and selecting the best across multiple agents
