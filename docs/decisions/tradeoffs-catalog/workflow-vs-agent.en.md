...
[#59 Spectrum Selector](../../patterns/01-execution/59-workflow-agent-spectrum-selector.md) dynamically selects workflow or agent per subtask. [#3 Workflow Backbone](../../patterns/01-execution/03-workflow-backbone-agent-node.md) fixes the skeleton as a workflow and delegates only the nodes requiring judgment to agents. Both adopt the strategy of "maximizing the scope covered by determinism and minimizing autonomy."
...
- [#3 Workflow Backbone + Agent Node](../../patterns/01-execution/03-workflow-backbone-agent-node.md) — Hybrid incorporating agent nodes into a deterministic skeleton
- [#11 Deterministic Core, Probabilistic Edge](../../patterns/02-composition/11-deterministic-core-probabilistic-edge.md) — Design principle of fixing the core with determinism and using AI only at the edges
- [#59 Workflow-Agent Spectrum Selector](../../patterns/01-execution/59-workflow-agent-spectrum-selector.md) — Meta-pattern for per-subtask selection
