...
「失敗コストが高いのだが、どのパターンを検討すればよいか」——そんなときに便利なのがこの逆引きです。自システムの [フォース評価](../foundations/forces.md) で「高」と判定した変数を起点に、関連する意思決定とパターンを引くことができます。「高い」ときに**特に注意すべき**ものと、「低い」ときに**緩和できる**ものの両面を示しています。
