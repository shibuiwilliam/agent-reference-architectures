...
- [#33 Version Pinning](../../decisions/dials/prompt-storage.md) -- Pin prompt, model, and tool versions to prevent unintended changes
- [#35 Production Replay](../../foundations/forces/f8-accountability.md) -- Replay production logs with the new model and detect differences from the old model
- [#36 Shadow / Canary Deployment](../../foundations/forces/f9-provider-reliability.md) -- Roll out model updates gradually and auto-rollback on issues
