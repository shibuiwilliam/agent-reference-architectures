...
設計の本質は「配分問題」です。各ユースケースに対して次の7つの予算を割り当て、**予算が尽きたときにどう振る舞うか**も必ずセットで決めてください。
...
この配分が、同期/非同期・単一/複数・短期/長期メモリ・強/弱ガードレール・詳細/要約ログといった [程度](../degrees/index.md)・[相反](../forks/index.md) を決めていきます。
