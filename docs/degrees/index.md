...
**原則：あらゆる目盛りは「効きすぎる害」と「効かなすぎる害」のち��うどよい中点を探す問題です。** ここに載せている目安値はあくまで出発点であり、[駆動変数](../concepts/driving-variables.md) に応じて動かしてください。固定のハードコードは避け、本番メトリクス（p99レイテンシ・ヒット率・評価スコア）をもとに継続的に再調整する変数として扱ってください。
