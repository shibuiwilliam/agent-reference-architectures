...
| B3 | [Agentic Loop with Budget｜予算付き自律ループ](b3-agentic-loop-budget.md) | `[F13, F2]` | `[task_variability, cost_sensitivity]` | stable |
| B4 | [Planner-Executor-Verifier｜計画・実行・検証の分離](b4-planner-executor-verifier.md) | `[F2, F4, F13]` | `[failure_cost, task_variability]` | stable |
| B5 | [Supervisor-Worker｜中央オーケストレーション](b5-supervisor-worker.md) | `[F6, F13, F15]` | `[task_variability, cost_sensitivity]` | stable |
