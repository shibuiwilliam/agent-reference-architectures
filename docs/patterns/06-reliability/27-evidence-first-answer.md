...
<!-- BEGIN:GEN:meta -->
<details markdown="1">
<summary>メタデータ（機械可読） — #27 Evidence-First Answer｜根拠優先回答</summary>
...
| **関連パターン** | #24, #28, #14 |
| **向き** | 法務・医療・金融Q&A、社内ナレッジ検索、監査証跡が必要なサポート |
| **不向き** | クリエイティブ・ブレインストーミング（正解ソースなし）; 根拠ソースが存在しない |
| **要素技術** | RAGパイプライン, Web検索API, 社内ドキュメントAPI, 信頼度評価, 引用メタデータ |
