...
<!-- BEGIN:GEN:meta -->
<details markdown="1">
<summary>メタデータ（機械可読） — #24 Context Pack / Assembly｜コンテキスト組立・RAG</summary>
...
| **フォース** | `[F4]`, `[F7]` |
| **ダイヤル** | retrieval-top-k |
| **二者択一** | rag-vs-finetuning |
| **関連パターン** | #23, #27, #39 |
| **向き** | 社内ナレッジ、サポート、法務・医療の最新情報依存 |
| **不向き** | モデルの汎用知識で十分; 極端なリアルタイムストリーム要求 |
| **要素技術** | Pinecone, pgvector, Cohere Rerank, HyDE, RecursiveCharacterTextSplitter |
