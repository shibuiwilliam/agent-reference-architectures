...
チャットUIだけでは、エージェントの長時間タスクを管理しきれない。計画の全体像、各ステップの進捗、中間成果物のプレビュー、承認待ちの操作がひとつの画面で把握できないと、ユーザーは「何をしているか分からない」という不安から介入タイミングを逃してしまう。Agent Workbenchは、チャットに加えて計画ビュー・進捗タイムライン・成果物パネル・承認ボタンを統合した操作画面を提供する。
