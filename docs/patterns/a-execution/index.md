...
| A2 | [Durable Async Agent｜耐久非同期セッション](a2-durable-async-agent.md) | `[F1, F7, F15, F16, F17]` | `[reversibility, latency_budget, accountability]` | stable |
...
| A6 | [Adaptive Timeout & Budget-Bounded Retry｜適応タイムアウト＋予算律速リトライ](a6-adaptive-timeout-retry.md) | `[F1, F7, F12]` | `[latency_budget, cost_sensitivity, failure_cost, provider_trust]` | stable |
